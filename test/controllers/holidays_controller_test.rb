...
class HolidaysControllerTest < ActionController::TestCase
  ...
  test "should create holiday" do
    assert_difference('Holiday.count') do
      post :create, holiday: { Department: @holiday.Department, Employee: @holiday.Employee, dateFrom: @holiday.dateFrom, dateTo: @holiday.dateTo }
    end
  ...
  test "should update holiday" do
    patch :update, id: @holiday, holiday: { Department: @holiday.Department, Employee: @holiday.Employee, dateFrom: @holiday.dateFrom, dateTo: @holiday.dateTo }
    assert_redirected_to holiday_path(assigns(:holiday))
  end
